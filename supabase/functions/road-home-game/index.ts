  ...
  const response = await fetch("https://api.openai.com/v1/chat/completions", {
    ...
    body: JSON.stringify({
      ...
      messages: [
        ...
        { role: "user", content: `Create 60 new, difficult but fair Bible questions for Full Circle: The Road Home. Match context: ${roomName}. Use multiple_choice, true_false, or standard_text. Multiple-choice questions need four plausible options and one exact correct_answer. Every standard_text correct_answer must be exactly one word; use multiple_choice whenever an answer needs two or more words. Questions must require memory, reasoning, attention to detail, and Scripture knowledge. Do not repeat or paraphrase any question in this existing list: ${existingPrompts.slice(-160).join(" | ")}. Return {"questions":[{"type":"multiple_choice","question":"...","options":["..."],"correct_answer":"...","reference":"...","explanation":"...","difficulty_tag":"hard"}]}.` },
      ],
