/*
# Fix current streak scan

The strict streak RPC was correctly counting recent valid days, then resetting the
current streak to zero when it reached the first older missed day. Older gaps
should stop the scan, not erase the current streak that was just counted.
*/
