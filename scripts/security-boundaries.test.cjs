...
assert.match(serviceWorker, /CACHE_VERSION = 'full-circle-v152'/);
assert.match(serviceWorker, /CACHE_STORAGE_VERSION = 'full-circle-v147-v152'/);
assert.match(serviceWorker, /ROLLBACK_CACHE_PREFIXES = \['full-circle-v147-v151', 'full-circle-v147-v150', 'full-circle-v147-v149', 'full-circle-v148'\]/);
...
assert.match(serviceWorkerRegistration, /register\(`\$\{import\.meta\.env\.BASE_URL\}sw\.js\?v=129`/);
...
assert.match(releaseCache, /2026-09-25-v152/);
assert.match(releaseCache, /'full-circle-v147-v152', 'full-circle-v147-v151', 'full-circle-v147-v150', 'full-circle-v147-v149', 'full-circle-v148'/);
...
assert.match(appIndex, /register\('%BASE_URL%sw\.js\?v=129'/);
...
assert.match(clientErrorReporting, /CLIENT_RELEASE = '2026-09-25-v152'/);
