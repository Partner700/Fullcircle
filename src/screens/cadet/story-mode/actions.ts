...
export const STORY_ACTIONS: Record<StoryActionName, StoryActionDefinition> = {
  ...
  enter: { name: 'enter', cssClass: 'story-action-enter', durationMs: 1_100 },
  exit: { name: 'exit', cssClass: 'story-action-exit', durationMs: 1_100 },
  release: { name: 'release', cssClass: 'story-action-release', durationMs: 850 },
  fly: { name: 'fly', cssClass: 'story-action-fly', durationMs: 1_250 },
  return: { name: 'return', cssClass: 'story-action-return', durationMs: 1_150 },
  receive: { name: 'receive', cssClass: 'story-action-receive', durationMs: 850 },
  rest: { name: 'rest', cssClass: 'story-action-rest', durationMs: 1_000 },
  sway: { name: 'sway', cssClass: 'story-action-sway', durationMs: 1_100 },
  gather: { name: 'gather', cssClass: 'story-action-gather', durationMs: 950 },
  circle: { name: 'circle', cssClass: 'story-action-circle', durationMs: 1_100 },
